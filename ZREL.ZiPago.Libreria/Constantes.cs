namespace ZREL.ZiPago.Libreria
{
    public static class Constantes
    {
        ...
        public const string strMensajeUsuarioRegistroCorrecto = "Usuario {0} registrado correctamente. A continuación será redirigido a nuestro portal web.";
        public const string strMensajeUsuarioNoRegistrado = "El Usuario ingresado no se encuentra registrado.";
        public const string strMensajeUsuarioYaExiste = "El Id ZiPago {0} ya existe. Intente registrarse con otra cuenta de correo electrónico.";
        ...
        public const string strMensajeEnvioMail = "Envío de correo electrónico realizado.";
        public const string strMensajeErrorEnvioMail = "No se pudo realizar el envío del correo electrónico.";
        ...
        public const string strMensajeEnvioEnlace = "Se realizó el envío de un enlace a su correo electrónico para que pueda restablecer su contraseña.";
        ...
        public const string strMensajeGeneralError = "No se puede realizar la operación solicitada. Por favor intentelo en unos minutos.";
    }
}
